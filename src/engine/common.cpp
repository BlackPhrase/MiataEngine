...
//
	bits = 0;
	if (cmd->viewangles[0] != from->viewangles[0])
		bits |= CM_ANGLE1;
	if (cmd->viewangles[1] != from->viewangles[1])
		bits |= CM_ANGLE2;
	if (cmd->viewangles[2] != from->viewangles[2])
		bits |= CM_ANGLE3;
	...
	if (bits & CM_ANGLE1)
		MSG_WriteAngle16 (buf, cmd->viewangles[0]);
	if (bits & CM_ANGLE2)
		MSG_WriteAngle16 (buf, cmd->viewangles[1]);
	if (bits & CM_ANGLE3)
		MSG_WriteAngle16 (buf, cmd->viewangles[2]);
